...
Running the regression model will produce an error when a column contains only a single value.

```{r, eval = FALSE}
glm_out <- ml_generalized_linear_regression(rescue_cat, 
                                 formula = "is_cat ~ typeofincident + engine_count + job_hours + hourly_cost + total_cost + incident_duration + propertycategory + originofcall + specialservicetype", 
                                 family = "binomial", 
                                 link = "logit")
```
