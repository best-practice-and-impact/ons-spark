...
Selecting a reference category can be particularly useful for inferential analysis, where there are particularly useful reference points. For example, in the `rescue_cat` dataset, we might want to select "Animal Rescue From Height" as our reference category because it is the largest defined special service type (aside from "Other Animal Assistance") and could serve as a useful reference point. 
...
rescue_cat_ohe <- rescue_cat %>%
  dplyr::mutate(specialservicetypecategory = ifelse(specialservicetypecategory == "Animal Rescue From Height",
...
# A tibble: 20 × 5
   ...
   <chr>                                      <dbl>     <dbl>     <dbl>    <dbl>
 1 (Intercept)                              1.47e+0   3.84e-1   3.83e+0 1.28e- 4
 ...
 5 specialservicetypecategory_Animal Resc… -4.23e-1   6.14e-2  -6.89e+0 5.76e-12
 6 specialservicetypecategory_Animal Resc… -1.42e+0   1.60e-1  -8.84e+0 0       
 7 specialservicetypecategory_Other Anima…  2.40e-2   9.80e-2   2.45e-1 8.07e- 1
